...
def test_parser():
    ...
    parser.add_argument('--debugorvalidate', type=str, default='validate',
                        help='to select debug or validate, default is validate')
...
def main():
    ...
    for i, batch_data in tqdm(enumerate(data_loader)):
        if opt.debugorvalidate == 'debug' and i > 0:
            break
        with torch.no_grad():
