...
def test_parser():
    ...
    parser.add_argument('--save_vis_n', type=int, default=20,
...
def main():
    ...
    if hypes['model']['args']['fusion_args']['communication']['thre'] is not None:
        opt.comm_thre = hypes['model']['args']['fusion_args']['communication']['thre']
