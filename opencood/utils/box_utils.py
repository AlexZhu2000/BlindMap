...
def zzh_project_single_point_by_matrix_torch(points, transformation_matrix):
    """
        Project the single point to another coordinate system based on the
        transfomration matrix. 
    ...
    projected_points = torch.matmul(transformation_matrix, points_homogeneous)  # Shape: (4,)
    return projected_points[:3].cpu().numpy()
